...
public class ApplicationTest {
    ...
    public static void setConnection() throws SQLException {
        connection = DriverManager.getConnection(DB_CONNECTION_URL + ADMIN_DB_NAME, DB_ADMIN_USER, DB_ADMIN_PASSWORD);
        ...
        executeSqlQuery("CREATE DATABASE " + DB_NAME + " OWNER " + DB_USER);
        connection.close();
    }
